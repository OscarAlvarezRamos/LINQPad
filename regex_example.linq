...
Dim xyz As Regex = New Regex("<a[^>]*>(?!<[A-Z][A-Z0-9]*\b[^><]*>[^><0-9]*)([0-9]+)(?=[^><0-9]*<)</a>")
...
Dim qry = (From match As System.Text.RegularExpressions.Match In searchTerm.Matches(str) Select match.groups(1).Value).distinct()
